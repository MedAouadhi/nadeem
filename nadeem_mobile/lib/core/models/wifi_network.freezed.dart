...
abstract class $WifiNetworkCopyWith<$Res> {
  ...
  @useResult
  $Res call({String ssid, int rssi, int auth});
}
...
/// @nodoc
@JsonSerializable()
class _$WifiNetworkImpl extends _WifiNetwork {
  const _$WifiNetworkImpl(
      {required this.ssid, required this.rssi, required this.auth})
      : super._();
  ...
  @override
  String toString() {
    return 'WifiNetwork(ssid: $ssid, rssi: $rssi, auth: $auth)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, ssid, rssi, auth);
...
abstract class _WifiNetwork extends WifiNetwork {
  const factory _WifiNetwork(
      {required final String ssid,
      required final int rssi,
      required final int auth}) = _$WifiNetworkImpl;
  const _WifiNetwork._() : super._();
